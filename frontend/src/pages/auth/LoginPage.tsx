...
import { useSocialLoginEnabled, use2FARequired } from '../../context/ConfigContext';
...
const LoginPage: React.FC = () => {
    ...
    const socialLoginEnabled = useSocialLoginEnabled();
    const require2FA = use2FARequired();
    ...
    const onSubmit = async (data: LoginForm) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                // Note: Backend should handle 2FA check and return requiresVerification if needed
                if (require2FA) {
                    // Check if backend indicates 2FA is needed
                    navigate('/verify-otp', { state: { email: data.email, type: '2fa' } });
                    return;
                }
                ...
                <div className="auth-panel input-panel">
                    <div className="auth-card">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="auth-form">
                            ...
                            {/* Social Login - Only shown if enabled */}
                            {socialLoginEnabled && (
                                <>
                            ...
                            {/* 2FA Notice */}
                            {require2FA && (
                                <div className="auth-info-message" style={{ marginTop: '1rem', padding: '0.75rem', background: 'rgba(99, 102, 241, 0.1)', borderRadius: '8px', fontSize: '0.875rem', color: '#6366f1' }}>
