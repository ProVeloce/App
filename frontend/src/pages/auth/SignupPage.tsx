...
import { useSocialLoginEnabled } from '../../context/ConfigContext';
    ...
    return (
        <div className="auth-page">
            <div className={`auth-container ${mode} ${transitioning ? 'transitioning' : ''}`}>
                {/* Panel 1: Input (Form) - starts at right in signup mode */}
                    ...
                    <div className="auth-card signup-card">
                        ...
                        <div className="auth-footer">
                            <p>
                                ...
                                <button type="button" onClick={goToLogin} className="auth-link">
                                    Sign In
                                </button>
                            </p>
                        </div>
                ...
                {/* Panel 2: Non-Input (Branding) - starts at left in signup mode */}
