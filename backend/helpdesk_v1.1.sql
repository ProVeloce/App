...
-- Add new columns to expert_helpdesk table
ALTER TABLE expert_helpdesk ADD COLUMN ticket_number TEXT UNIQUE;
...
CREATE INDEX IF NOT EXISTS idx_helpdesk_ticket_number ON expert_helpdesk(ticket_number);
